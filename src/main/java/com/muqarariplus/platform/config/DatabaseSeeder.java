...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    private void seedIndustryHierarchy() {
        ...
        String[][] tools = {
                ...
                {"CrowdStrike","كراود سترايك"},{"Splunk","سبلنك"},{"Fortinet FortiGate","فورتينت ffortiGate"},
    ...
    private String classifyCourse(Course course) {
        ...
        if (n.contains("circuit") || n.contains("دوائر") || n.contains("logic design") || n.contains("منطقي")
                ...
                || n.contains("embedded") || n.contains("مضمن") || n.contains("vlsi") || n.contains("metakamelh")
        ...
        if (n.contains("math") || n.contains("رياضيات") || n.contains("calculus") || n.contains("تفاضل")
                ...
                || n.contains("إحصاء") || n.contains("ahimal") || n.contains("physics") || n.contains("فيزياء")
